...
public class reAdapter extends RecyclerView.Adapter<reAdapter.MyViewHolder> implements Filterable {
 ...
 Context context;
 ArrayList<SelfDefenceModel> titleArray;
 ArrayList<SelfDefenceModel> getTitleArrayfull;

    public reAdapter(Context context, ArrayList<SelfDefenceModel> titleArray) {
    ...
    public void onBindViewHolder(@NonNull reAdapter.MyViewHolder holder, int position) {
        ...
        SelfDefenceModel getData = titleArray.get(position);
    ...
    private Filter exampleFilter = new Filter() {
        ...
        protected FilterResults performFiltering(CharSequence charSequence) {
            List<SelfDefenceModel> filterList = new ArrayList<>();
            if (charSequence == null || charSequence.length() == 0)
            {
                ...
                for (SelfDefenceModel item:getTitleArrayfull)
                {
